...
const buildRuntimePrelude = (userCode) => {
    ...
    return [
        ...
        "    'sprite_clicked': [], 'stage_clicked': [], 'backdrop_switched': {}, 'touching_object': {}}",
        "",
        ...
        "    'orangered': '#FF4500', 'tomato': '#FF6347', 'coral': '#FF7F50',",
        "    'darkorange': '#FF8C00', 'orange': '#FFA500', 'gold': '#FFD700',",
        "    'yellow': '#FFFF00', 'olive': '#808000', 'darkkhaki': '#BDB76B',",
        "    'greenyellow': '#ADFF2F', 'yellowgreen': '#9ACD32', 'lawngreen': '#7CFC00',",
        "    'lime': '#00FF00', 'limegreen': '#32CD32', 'forestgreen': '#228B22',",
        "    'green': '#008000', 'darkgreen': '#006400', 'seagreen': '#2E8B57',",
        "    'mediumseagreen': '#3CB371', 'springgreen': '#00FF7F', 'teal': '#008080',",
        "    'darkcyan': '#008B8B', 'cyan': '#00FFFF', 'aqua': '#00FFFF',",
        "    'deepskyblue': '#00BFFF', 'dodgerblue': '#1E90FF', 'royalblue': '#4169E1',",
        "    'blue': '#0000FF', 'mediumblue': '#0000CD', 'darkblue': '#00008B',",
        "    'navy': '#000080', 'midnightblue': '#191970', 'cornflowerblue': '#6495ED',",
        "    'steelblue': '#4682B4', 'cadetblue': '#5F9EA0', 'lightskyblue': '#87CEFA',",
        "    'skyblue': '#87CEEB', 'lightblue': '#ADD8E6', 'powderblue': '#B0E0E6',",
        "    'indigo': '#4B0082', 'purple': '#800080', 'darkmagenta': '#8B008B',",
        "    'mediumorchid': '#BA55D3', 'darkviolet': '#9400D3', 'blueviolet': '#8A2BE2',",
        "    'mediumslateblue': '#7B68EE', 'slateblue': '#6A5ACD', 'darkorchid': '#9932CC',",
        "    'plum': '#DDA0DD', 'violet': '#EE82EE', 'thistle': '#D8BFD8',",
        "    'magenta': '#FF00FF', 'fuchsia': '#FF00FF', 'orchid': '#DA70D6',",
        "    'hotpink': '#FF69B4', 'lightpink': '#FFB6C1', 'pink': '#FFC0CB',",
        "    'palevioletred': '#DB7093', 'deeppink': '#FF1493', 'cornsilk': '#FFF8DC',",
        "    'blanchedalmond': '#FFEBCD', 'bisque': '#FFE4C4', 'navajowhite': '#FFDEAD',",
        "    'wheat': '#F5DEB3', 'burlywood': '#DEB887', 'tan': '#D2B48C',",
        "    'rosybrown': '#BC8F8F', 'lavender': '#E6E6FA', 'linen': '#FAF0E6',",
        "    'oldlace': '#FDF5E6', 'ivory': '#FFFFF0', 'beige': '#F5F5DC',",
        ...
        "        key = str(value)",
        "        for h in _event_handlers['touching_object'].get(key, []): h()",
        "        return",
        ...
        "def nlp_classify(text): return _extension_rpc('nlp_classify', [text])",
        "def nlp_classify_result(text): return _extension_rpc('nlp_classifyResult', [text])",
        "def nlp_entities(text): return _extension_rpc('nlp_entities', [text])",
        "def nlp_train(label, examples): return _extension_rpc('nlp_train', [label, examples])",
        "def nlp_remove_intent(label): return _extension_rpc('nlp_removeIntent', [label])",
        "def nlp_similarity(t1, t2): return _extension_rpc('nlp_similarity', [t1, t2])",
        "def nlp_load_sample_intents(): return _extension_rpc('nlp_loadSampleIntents')",
        ...
        "nomopro_nlp.sentiment_score = nlp_sentiment_score",
        "nomopro_nlp.classify = nlp_classify",
        "nomopro_nlp.classify_result = nlp_classify_result",
        "nomopro_nlp.entities = nlp_entities",
        "nomopro_nlp.train = nlp_train",
        "nomopro_nlp.remove_intent = nlp_remove_intent",
        "nomopro_nlp.similarity = nlp_similarity",
        "nomopro_nlp.load_sample_intents = nlp_load_sample_intents",
        "nomopro_nlp.export_training = nlp_export_training",
        ...
        "    any(_event_handlers.get('touching_object', {}).values()) or",
        "    _broadcast_handlers",
        ")",
        "if _has_handlers:",
        "    try:",
