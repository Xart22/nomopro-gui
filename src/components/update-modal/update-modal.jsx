...
const calculateProgressBarValue = (progress) =>
    parseFloat(
        (
            progress * (100 - PROGRESS_INITIAL_OFFSET_VALUE) +
            PROGRESS_INITIAL_OFFSET_VALUE
        ).toFixed(1)
...
const UpdateModalComponent = (props) => {
    let updateMessage;
    if (
        props.updateState.phase ===
            UPDATE_MODAL_STATE.resourceUpdateAvailable ||
        props.updateState.phase ===
            UPDATE_MODAL_STATE.applicationUpdateAvailable
    ) {
        if (typeof props.updateState.info.message === "object") {
            if (props.updateState.info.message[`${props.intl.locale}`]) {
                updateMessage =
                    props.updateState.info.message[`${props.intl.locale}`];
    ...
    return (
        ...
        >
            <Box className={styles.body}>
                {props.updateState.phase ===
                    UPDATE_MODAL_STATE.checkingResource ||
                props.updateState.phase ===
                    UPDATE_MODAL_STATE.checkingApplication ? (
                    <div>
                ...
                props.updateState.phase ===
                    ...
                    <div>
                        ...
                        <div className={styles.updateInfo}>
                            {updateMessage
                                ? Object.keys(updateMessage).map(
                                      (subTitle, index) => (
                                          <div key={index}>
                                              <div
                                                  className={
                                                      styles.updateInfoSubTitle
                                                  }
                                              >
                                                  {subTitle}
                                              </div>
                ...
                {props.updateState.phase === UPDATE_MODAL_STATE.latest ? (
                    <div>
                        ...
                        <div className={styles.updateInfo}>
                            <FormattedMessage
                                defaultMessage="Nomokit is already the latest version."
                ...
                {props.updateState.phase ===
                UPDATE_MODAL_STATE.resourceUpdating ? (
                    <div>
                        <div className={styles.updateTitle}>
                            <FormattedMessage
                        ...
                        <div className={styles.updateInfo}>
                            <div
                                className={classNames(styles.updateInfoWrapper)}
                            >
                                <div>
                                    {props.updateState.info.phase ===
                                    RESOURCE_UPDATE_STATE.downloading
                                        ? downloading
                                        : null}
                                    {props.updateState.info.phase ===
                                    RESOURCE_UPDATE_STATE.deleting ? (
                                        props.updateState.info.state.name ===
                                        RESOURCE_UPDATE_CONTENT.zip ? (
                                            <FormattedMessage
                                    ...
                                    {props.updateState.info.phase ===
                                    RESOURCE_UPDATE_STATE.extracting ? (
                                        <FormattedMessage
                                    ...
                                    {props.updateState.info.phase ===
                                    RESOURCE_UPDATE_STATE.verifying ? (
                                        props.updateState.info.state.name ===
                                        RESOURCE_UPDATE_CONTENT.zip ? (
                                            <FormattedMessage
                            ...
                            <div className={classNames(styles.progressWrapper)}>
                                {progressBar(
                                    calculateProgressBarValue(
                                        props.updateState.info.progress
                                    )
                                )}
                            </div>
                            {props.updateState.info.state ? (
                            ...
                            <button
                                ...
                                disabled={
                                    ...
                                    (props.updateState.info.phase ===
                                        RESOURCE_UPDATE_STATE.verifying &&
                                        props.updateState.info.state.name ===
                                            RESOURCE_UPDATE_CONTENT.cache) ||
                                    (props.updateState.info.phase ===
                                        RESOURCE_UPDATE_STATE.deleting &&
                                        (props.updateState.info.state.name ===
                                            RESOURCE_UPDATE_CONTENT.errorCache ||
                                            props.updateState.info.state
                                                .name ===
                                                RESOURCE_UPDATE_CONTENT.zip))
                                }
                ...
                {props.updateState.phase ===
                UPDATE_MODAL_STATE.resourceUpdatFinish ? (
                    <div>
                        <div className={styles.updateTitle}>
                            <FormattedMessage
                ...
                {props.updateState.phase ===
                UPDATE_MODAL_STATE.applicationDownloading ? (
                    <div>
                        <div className={styles.updateTitle}>
                            <FormattedMessage
                ...
                {props.updateState.phase ===
                UPDATE_MODAL_STATE.applicationDownloadFinish ? (
                    <div>
                        <div className={styles.updateTitle}>
                            <FormattedMessage
...
export { UpdateModalComponent as default };
