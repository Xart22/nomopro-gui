...
const SerialTerminal = ({
    ...
    useEffect(() => {
        if (
            window.__serialTerminalBuffer &&
            window.__serialTerminalBuffer.byteLength > 0
        ) {
    ...
    const appendData = useCallback(
        (data) => {
            ...
            pausedBufferRef.current = (() => {
                ...
                const combined = new Uint8Array(
                    buf.byteLength + bytes.byteLength,
                );
                combined.set(buf, 0);
        ...
        [throttleUpdate, isTerminalActive],
    ); // isPaused via ref to avoid stale closure & listener churn
    ...
    return (
        ...
        >
            ...
            >
                ...
                <button onClick={handleClear} title="Clear" style={btnStyle}>
                    🗑
                </button>
