...
import UploadProgressComponent, {
    PHASES,
} from "../components/upload-progress/upload-progress.jsx";
...
const UPLOAD_TIMEOUT_TIME = 600 * 1000; // 60s
...
class UploadProgress extends React.Component {
    constructor(props) {
        ...
        this.state = {
            extension: this.props.deviceData.find(
                (dev) => dev.deviceId === props.deviceId
            ),
    ...
    componentDidMount() {
        ...
        this.props.vm.on(
            ...
            this.handleSetUploadAbortEnabled
        );
    }
    componentWillUnmount() {
        this.props.vm.removeListener(
            "PERIPHERAL_UPLOAD_STDOUT",
            this.handleStdout
        );
        this.props.vm.removeListener(
            "PERIPHERAL_UPLOAD_ERROR",
            this.handleUploadError
        );
        this.props.vm.removeListener(
            "PERIPHERAL_CONNECTION_LOST_ERROR",
