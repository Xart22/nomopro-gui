...
class GUI extends React.Component {
    ...
    handleActivateTab = (tab) => {
        ...
        if (isSwitchToPythonOnWeb) {
            ...
            this.props.onClearSelectedDeviceAndConnection();
        }
    ...
    componentDidMount() {
        ...
        // Always show onboarding modal on app load unless dismissed
...
GUI.propTypes = {
    ...
    onClearSelectedDeviceAndConnection: PropTypes.func,
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        extensionConnectionModalVisible: state.scratchGui.modals.extensionConnectionModal,
        onboardingVisible: state.scratchGui.modals.onboarding,
...
const mapDispatchToProps = (dispatch) => ({
    ...
    onClearSelectedDeviceAndConnection: () => {
        dispatch(clearDeviceId());
        dispatch(clearDeviceName());
        dispatch(clearConnectionModalPeripheralId());
    ...
    onOpenOnboarding: () => dispatch(openOnboarding()),
